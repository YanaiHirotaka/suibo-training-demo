const CACHE_NAME = 'suibo-training-v81';
const APP_ASSETS = [
  './',
  './index.html',
  ...
  './modules/character-motion.js?v=20260915-2',
  ...
  './modules/mission-state.js?v=20260916-1',
  './modules/disaster-events.js?v=20260916-1',
